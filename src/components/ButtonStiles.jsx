...
const ButtonStiles = ({ text, href, styleType, extraStyle }) => {
    const styles = {
    ...
    const className = `font-semibold text-base p-4 min-w-64 rounded-full uppercase transition-all ${styles[styleType] || 'bg-white'} ${extraStyle || ''}`;
