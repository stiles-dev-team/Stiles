...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    const validateToken = async () => {
      try {
        const response = await fetch('https://staging.stiles.co.za/api/validate-reset-token.php', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://staging.stiles.co.za/api/reset-password.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
