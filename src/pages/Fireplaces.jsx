    ...
    <Layout>
        ...
        <section className='container mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-10'>
            <div className='flex flex-col justify-start items-start gap-5 w-full'>
                ...
                <ButtonStiles openInNewTab text='Visit National Website' styleType="dark" href='https://kamadojan.co.za/?_ga=2.175592098.1614544313.1740408143-748394691.1737046589' respFullWidth extraStyle=" text-sm" />
            </div>
            <div className='flex flex-col justify-start items-start gap-5 w-full'>
            <img src='/images/calore.svg' alt='Calore' className='w-full max-w-56 object-cover object-center' />
                ...
                <ButtonStiles openInNewTab text='Visit National Website' styleType="dark" href='https://calore.co.za/?_ga=2.253704969.1614544313.1740408143-748394691.1737046589' respFullWidth extraStyle="w-f text-sm" />
            </div>
        </section>
    </Layout>
  )
