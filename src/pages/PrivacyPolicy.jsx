      ...
      <div className="container mx-auto px-4 py-20 leading-snug flex flex-col justify-start items-start gap-5">
          ...
          <ul className="list-disc list-inside flex flex-col gap-3">
            ...
            <li>
              ...
              Company”, “We”, “Us” or “Our” in this Agreement) refers to Stiles,
              11 Commercial Cl, Levallia, George, 6529.
            </li>
            <li>
          ...
          <h1 className="font-bold text-xl">Collecting and Using Your Personal Data</h1>
          <h2 className="font-bold text-lg">Types of Data Collected</h2>
          <h3>Personal Data</h3>
          <p>
          ...
          <ul className="list-disc list-inside flex flex-col gap-3">
            ...
            <li>
              ...
              Persistent CookiesAdministered by: UsPurpose: These Cookies
          ...
          <h2 className="font-bold text-lg">Retention of Your Personal Data</h2>
          <p>
          ...
          <h2 className="font-bold text-lg">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h2 className="font-bold text-lg">Disclosure of Your Personal Data</h2>
          ...
          <h2 className="font-bold text-lg">Security of Your Personal Data</h2>
          <p>
          ...
          <ul className="list-disc list-inside flex flex-col gap-3">
            <li>By email:&nbsp;info@stiles.co.za</li>
            <li>By phone number: +27 (021) 510 8310</li>
          </ul>
        </div>
    </Layout>
  );
