    ...
    useEffect(() => {
        ...
        const fetchBrandInfo = async () => {
            try {
                ...
                const response = await fetch(`https://staging.stiles.co.za/api/products.php?brand=${slug}&info=true`);
                if (!response.ok) {
...
const Content = ({
    ...
    useEffect(() => {
        ...
        const fetchFilterValues = async () => {
            try {
                const response = await fetch(`https://staging.stiles.co.za/api/products.php?brand=${slug}&filters=true`);
                if (!response.ok) {
